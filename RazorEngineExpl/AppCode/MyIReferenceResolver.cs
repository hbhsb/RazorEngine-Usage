...
namespace RazorEngineExpl.AppCode
{
    public class MyIReferenceResolver : IReferenceResolver
    {
        ...
        public IEnumerable<CompilerReference> GetReferences(TypeContext context, IEnumerable<CompilerReference> includeAssemblies)
        {
            ...
            yield return CompilerReference.From(FindLoaded(loadedAssemblies, "System.Data.dll"));
            yield return CompilerReference.From(FindLoaded(loadedAssemblies, "System.Xml.dll"));
            ...
            yield return CompilerReference.From(FindLoaded(loadedAssemblies, "ModelClassLibrary.dll"));
